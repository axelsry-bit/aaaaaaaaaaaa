...
module.exports = {
    ...
    execute(client, message, args) {
        ...
        if(!channel) return message.channel.send(`Je n'ai pas réussi à trouver le salon des suggestions. Veuillez mentionner <@691400952673992815> afin que le problème soit résolu.`)
